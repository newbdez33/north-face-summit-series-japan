...
[![在线阅读](https://img.shields.io/badge/📖_在线阅读-GitHub_Pages-2ea44f?style=for-the-badge)](https://newbdez33.github.io/north-face-summit-series-japan/)
&nbsp;
![单文件 HTML](https://img.shields.io/badge/单文件-HTML_·_零依赖-e8392c?style=for-the-badge)
&nbsp;
![语言](https://img.shields.io/badge/语言-简体中文-5fcedd?style=for-the-badge)

### 👉 [newbdez33.github.io/north-face-summit-series-japan](https://newbdez33.github.io/north-face-summit-series-japan/)

[![首屏预览](preview.png)](https://newbdez33.github.io/north-face-summit-series-japan/)
...
| 分层 | 产品 | 关键技术 | 型号 | 参考价 |
|------|------|----------|------|--------|
| 硬壳 | Ascent Peak Jacket | 70D GORE-TEX Pro（ePE 膜） | [`NP62521`](https://www.yodobashi.com/product/100000001009270898/) | ¥72,600 |
...
| 活动羽绒 L3 | L3 50/50 Down Hoodie | 800FP ProDown | [`ND52022`](https://www.yodobashi.com/product/100000001005736593/) | ¥52,800 |

> **货号与链接说明**：链接按可用性分配 —— 抓绒 `NL22622` → **Goldwin 官方直达商品页**（在售）；`NP62521`(硬壳)、`ND52022`(50/50) → **Yodobashi 商品页**（有详细介绍，可能缺货）；`ND92520`(羽绒)、`NY82520`(VENTRIX) 未找到零售商单品页，故 → **官方 Summit Series 2025 特辑页**。截至 **2026-06**（FW2025/FW2026 换季期）Goldwin 多数 FW2025 单品页已下架（HTTP 404）；零售渠道抓绒款货号或为 `NL72322`；`NY82520` 另有限定配色 `NY82520R`（UNDYED × SUMMIT GOLD）。均为 UNISEX；货号 / 价格随季节 / 库存变动，以各页面为准。
